...
class Release extends Component {
    ...
    componentDidMount(){
        ...
        this.props.fetchInfoByType(id, "release");
    }
                                ...
                                <div className="col-md-3">
                                    <div className="panel panel-primary">
                                        ...
                                        <div className="panel-body">
                                                                ...
                                                                info.formats.map(function (format) {
                                                                    return (
                                                                        <span key={format.name}>
                                                                            ...
                                                                            <span>
                                                                                {
                                                                                    format.descriptions.map(function (d) {
                                            ...
                                            <p>Released: {info.released_formatted}</p>
                                            <p>Year: {info.year}</p>
                                            <p>Genres:
                                                {
...
//searchByType
export default connect(mapStateToProps, {fetchInfoByType})(Release);